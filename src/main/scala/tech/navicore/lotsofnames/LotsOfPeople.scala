...
object LotsOfPeople {
  ...
  val people: Array[String] =
    Source.fromResource("people.txt").getLines().toArray
  val middle: Array[String] =
    Source.fromResource("middle.txt").getLines().toArray
  val things: Array[String] =
    Source.fromResource("things.txt").getLines().toArray
